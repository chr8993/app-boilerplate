...
function buildNav(members) {
    var nav = '<a href="/" class="brand-logo" style="font-weight: 300 !important; font-family: Roboto; font-size: 24px;"><strong>__projectName__</strong></a>',
        seen = {},
        hasClassList = false,
        globalNav = '';
    nav += "<ul class='right'>";
    nav += "<li><a href='/docs'>Home</a></li>";
    if (members.modules.length) {
        nav += '<li><a href="#">Modules</a></li>';
    }
    ...
    if (members.classes.length) {
        ...
        for (var groupName in groups) {
            ...
            if (classNav !== '') {
                nav += '<li><a href="#" class="dropdown-button" data-activates="' + groupName + '">';
                nav += groupName + '<i class="material-icons right">arrow_drop_down</i></a></li>';
                nav += "<ul id='" + groupName +"' class='dropdown-content'>";
                nav += classNav;
                nav += '</ul>';
            }
        } // for
